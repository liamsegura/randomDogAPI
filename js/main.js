...
fetch(BREEDS_URL)
    ...
    const getDoggoImg = url => {
      ...
      return array;
        ...
        assignLikes() {
            this.likes = this.yatesShuffle(this.likesList).slice(0,2)
            document.getElementById("dog-likes").innerHTML = `Likes: ${this.likes[0]}, ${this.likes[1]}`
        },

        assignDislikes() {
            this.dislikes = this.yatesShuffle(this.dislikesList).slice(0,2)
            document.getElementById("dog-dislikes").innerHTML = `Dislikes: ${this.dislikes[0]}, ${this.dislikes[1]}`
        },
